...
def Click(url):
    ...
    # 8
    Nornoal(driver,1,2,HH)
    # 9
    Cmanychoice(driver,[1,2,3,4],II)
    # 10
    Cmanychoice(driver,[1,2,3,4],JJ)
    # 11
    Nornoal(driver,2,3,KK)
    # 12
...
if __name__ == '__main__':
    url = "https://www.wjx.cn/m/80136316.aspx?pwx=1"
    for i in range(25):#输入数字
        try:
            t1 = time.time()
            Click(url)
            t2 = time.time()
