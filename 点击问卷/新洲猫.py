...
SS='/html/body/form/div[5]/div[3]/fieldset/div[19]/div[2]/div[%s]/span/a'
...
def Click(url):
    ...
    Justone(driver, 1, DD)
    # 5
    Nornoal(driver,2,4,EE)
    # 6、
    Choose(driver,[1,3],FF)
    # 7
    Nornoal(driver,1,3,GG)
    # 8
    Nornoal(driver,1,4,HH)
    # 9
    Cmanychoice(driver,[1,2,6,7],II)
    # 10
    Nornoal(driver,2,3,JJ)
    # 11
    Nornoal(driver,1,2,KK)
    # 12
    Cmanychoice(driver, [1, 2, 3, 7], LL)
    # 13
    Nornoal(driver,3,4,MM)
    # 14
    Nornoal(driver,1,2,NN)
    # 15
    Nornoal(driver,1,4,OO)
    # 16
    Choose(driver,[1,3,5],PP)
    # 17
    Nornoal(driver,1,2,QQ)
    # 18
    Justone(driver, 1, RR)
    # 19
    Choose(driver, [2,4,5], SS)
    # 提交
...
if __name__ == '__main__':
    url = "https://www.wjx.cn/m/76478322.aspx?from=timeline"
